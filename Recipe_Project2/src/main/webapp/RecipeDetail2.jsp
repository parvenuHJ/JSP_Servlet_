        ...
        <div id="contents_area_full" style="clear:both;">
            <div class="view2_pic">
                ...
                <div class="centeredcrop">
                    <img id="main_thumbs"
                        src=<%=recipeOneList.get(0).getRe_url() %>
                        alt="main thumb">
                </div>
            </div>
           ...
           <% for(int i = 0 ; i < RecipeDetailList.size(); i++) { %>
            <div id="stepDiv1" class="view_step_cont media step1">
                <div id="stepimg1" class="media-right">
                    <img
                        src="<%=RecipeDetailList.get(i).getDe_url()%>">
                </div>
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="<%=food_name %>" id="keyword" size="5"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=67e6e65c1944c28da3758e59709bc702&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
            ...
            <div class="view_reply st2">
                ...
                <div class="media reply_list">
                    <div class="media-left">
                        <a href="/profile/review.html?uid=76848668">
                ...
                <div class="view_reply">
                    <div class="reply_tit">
                        ...
                        <div class="reply_write">
                                <%if(loginVO != null){ %>
                            <form id="insCmtFrm1" action = "CommentInsert.do" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="re_code" name="re_code" value="<%=recipeOneList.get(0).getRe_code()%>">
								<input type="hidden" id="mem_id" name="mem_id" value="<%=loginVO.getMem_id()%>">
                                <div>
	                                <div class="input-group" style="width:100%;">
	                                    <textarea id="cmt_tx_content1" 
	                                        name="co_text" class="form-control" placeholder=""
	                                        style="height:75px; width:250%; resize:none;"></textarea>
	                                </div>
                                </div>
                                    <div class="file-submit">
                                    <input type="hidden" id="food_name" name="food_name" value="<%=food_name%>">
	                                <input type="file" name="co_img" id="file_1">
	                                <input type="submit" id="CommentInsert "value="작성하기">
                                </div>
                                <span id=reply></span>
                                <div class="blank_bottom"></div>
                                <div>

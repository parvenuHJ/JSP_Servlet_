  ...
  <!-- sidebar -->
        <div id="sidebar">
            <div class="navigation">
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://mail.naver.com/write/popup?srvid=note&to=admin@naver.com">
                            <span class="icon">
                                <span class="material-symbols-outlined">
                                    mail
                                </span>
        ...
        <div class="home">
            ...
            <div class="container">
                ...
                <button id="cell_b" onclick="location.href='Relike.jsp'">좋아요</button>
                <button id="cell_c" onclick="location.href='MemberComment.jsp'">내 댓글</button>
               <button id="cell_d" onclick="location. href='https://mail.naver.com/write/popup?srvid=note&to=admin@naver.com'">문의사항</button>
            </div>
